    ...
    >
      ...
      {isEnrolled && onRemove ? (
        <button
          ...
          aria-label="Disenroll from course"
          title="Disenroll from course"
          className="absolute left-3 top-3 inline-flex items-center justify-center rounded-full bg-white px-3 py-1 text-xs font-semibold text-red-600 shadow hover:bg-red-50"
        >
          Disenroll
        </button>
      ) : null}
